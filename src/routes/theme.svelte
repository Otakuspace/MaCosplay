...
<div class="container mx-auto p-6 bg-primary">
  ...
  <ul class="list-decimal list-inside mb-6 text-secondary space-y-2">
    ...
    <li>2021 - Started learning interesting topics on YouTube, Coursera, and Udemy, tried some small AI projects, and wrote my first Ethereum Solidity smart contract lottery game.</li>
    <li>2021 Dec - Joined Global Chainlink Blockchain Fall Hackathon 2021 and won $1300. Learn more about the project!</li>
    <li>2022 - Founded the school science days project LASER TAG where we used Microbit to build a laser tag shooting range game.</li>
    <li>2022 - Took IELTS 3 times in one year until I achieved an overall score of 6.5.</li>
    <li>2022 - Worked on a Blockchain Research development project - Decentralized document storage using IPFS and Polygon blockchain.</li>
    <li>2022 - Got an opportunity to join the WICE research competition on-site in Malaysia and received a Silver Medal.</li>
    <li>2023 - I decided to apply to only 2 universities: NUS and Chula. I got rejected from NUS, so I went to Chula Engineering.</li>
    <li>2024 - Started to stick and learn SvelteKit and PocketBase for full-stack web development.</li>
    <li>2024 - I started the AstralRC YouTube channel to teach Unreal Engine 5 game development.</li>
    <li>2024 - Took a gap semester after the second semester at Chula to focus on working on my startup celestiai.co.</li>
    <li>2024 Jul - Joined buildspace s5 nights&weekends building ReniTube - A website where you can create your personal AI anime assistant (live2d).</li>
    <li>2024 Jul - Got accepted into Gen-ed Chula - Design Thinking classes.</li>
    <li>2024 Aug - Working on shipcourse.in, a SaaS for shipping your online course fast. Developed in 3 days and started to talk to people for feedback.</li>
    <li>2024 Aug - Started learning basic Rust language.</li>
    <li>2024 Aug - Mostly studying for the Digital SAT since June.</li>
    <li>2024 Aug - celestiai.co, my startup, generated 50k baht revenue in the past 3 months, now got 7k users.</li>
    <li>Won ICP Chainfusion Hacker House 2nd prize $1500 - I built an AI Vtuber marketplace (solo hacker); I learned about ICP (Dfinity - Internet Computer) technology, which is a blockchain that can deploy full-stack web, game, and storage (fully on-chain). It uses smart contracts called canisters: a Solidity smart contract but on ICP. It uses Motoko or Rust language to write back-end contracts. Learn more on GitHub!</li>
